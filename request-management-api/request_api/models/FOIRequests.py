...
class FOIRequest(db.Model):
    ...
    def saverequest(cls,foirequest)->DefaultMethodResult:
        ...
        for ministry in foirequest.ministryRequests:
            ...
            ministryarr.append({"id": ministry.foiministryrequestid, "axisrequestid": ministry.axisrequestid, "filenumber": ministry.filenumber, "status": ministry.requeststatus.name, "assignedministrygroup": assignedministrygroup, "assignedgroup": assignedgroup, "version":ministry.version})    
