...
class requestservicebuilder(requestserviceconfigurator):
    ...
    def createapplicant(self,firstname, lastname, appltcategory, userid, middlename = None, businessname = None, alsoknownas = None, dob = None, applicantcategoryid = None, axisapplicantid = None):
        requestapplicant = FOIRequestApplicantMapping()
        _applicant = FOIRequestApplicant().createapplicant(firstname, lastname, middlename, businessname, alsoknownas, dob, applicantcategoryid, axisapplicantid, userid)
