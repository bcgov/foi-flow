...
class requestserviceministrybuilder(requestserviceconfigurator):
    ...
    def createfoirequestfromobject(self, foiobject, userid):
        ...
        foirequest.deliverymodeid =  foiobject["deliverymode.deliverymodeid"] if 'deliverymode' in foiobject and foiobject["deliverymode.deliverymodeid"] or foiobject["deliverymode.deliverymodeid"] is not None else None
