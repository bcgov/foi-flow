...
export const KeywordSearchFooter = ({rowCount, defaultSortModel, footerFor}) => {
    ...
    useEffect(() => {
      if(resumeDefaultSorting) {
        if((showKeywordSearch && footerFor == 'keywordsearch') || (!showKeywordSearch && footerFor != 'keywordsearch')) {
