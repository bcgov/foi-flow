...
const StateEnum = Object.freeze({
  open: { name: "Open", id: 1, label: "open" },
  callforrecords: { name: "Call For Records", id: 2, label: "callforrecords" },
  callforrecordsoverdue: {
    name: "Call For Records Overdue",
    id: -100,
    label: "callforrecordsoverdue",
  },
  closed: { name: "Closed", id: 3, label: "closed" },
  redirect: { name: "Redirect", id: 4, label: "redirect" },
  unopened: { name: "Unopened", id: 5, label: "unopened" },
  intakeinprogress: {
    name: "Intake in Progress",
    id: 6,
    label: "intakeinprogress",
  },
  review: { name: "Records Review", id: 7, label: "recordsreview" },
  feeassessed: { name: "Fee Estimate", id: 8, label: "feeestimate" },
  consult: { name: "Consult", id: 9, label: "consult" },
  signoff: { name: "Ministry Sign Off", id: 10, label: "ministrysignoff" },
  onhold: { name: "On Hold", id: 11, label: "onhold" },
  deduplication: { name: "Deduplication", id: 12, label: "deduplication" },
  harms: { name: "Harms Assessment", id: 13, label: "harmsassessment" },
  response: { name: "Response", id: 14, label: "response" },
  archived: { name: "Archived", id: 15, label: "archived" },
  peerreview: { name: "Peer Review", id: 16, label: "peerreview" },
  tagging: { name: "Tagging", id: 17, label: "tagging" },
  readytoscan: { name: "Ready to Scan", id: 18, label: "readytoscan" },
  appfeeowing: { name: "App Fee Owing", id: 19, label: "appfeeowing" },
  section5pending: {
    name: "Section 5 Pending",
    id: 20,
    label: "section5pending",
  },
});
