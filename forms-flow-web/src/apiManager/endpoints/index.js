...
const API = {
  ...
  FOI_REQUEST_GET_FIELD: `${FOI_BASE_API_URL}/api/foirequests/<requestid>/ministryrequest/<ministryid>/field/<field>`,
  FOI_REQUEST_GET_FIELD_BY_AXISID: `${FOI_BASE_API_URL}/api/foirequests/<axisrequestid>/field/<field>`,
