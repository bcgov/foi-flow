...
const API = {
  ...
  FOI_POST_CFR_FORM: `${FOI_BASE_API_URL}/api/foicfrfee/ministryrequest/<ministryrequestid>/cfrfeeid/<cfrfeeid>`,
  FOI_POST_CFR_FORM_IAO: `${FOI_BASE_API_URL}/api/foicfrfee/ministryrequest/<ministryrequestid>/cfrfeeid/<cfrfeeid>/sanction`,
