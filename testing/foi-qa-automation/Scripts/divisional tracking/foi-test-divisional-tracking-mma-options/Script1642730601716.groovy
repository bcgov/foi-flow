...
WebUI.callTestCase(findTestCase('helper/foi-test-login'), [('password') : findTestData('New Test Data').getValue('Password', 13)
        , ('username') : findTestData('New Test Data').getValue('Username', 13)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Immigration Services and Strategic Planning'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Management Services'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Local Government'), 0)
