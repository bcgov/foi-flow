...
WebUI.callTestCase(findTestCase('helper/foi-test-login'), [('password') : findTestData('Login Credentials').getValue('Password', 
            13), ('username') : findTestData('Login Credentials').getValue('Username', 13)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/ministry view/form/divisional tracking/division dropdown options/muni/li_Immigration Services and Strategic Planning'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/ministry view/form/divisional tracking/division dropdown options/muni/li_Local Government'), 
    0)
