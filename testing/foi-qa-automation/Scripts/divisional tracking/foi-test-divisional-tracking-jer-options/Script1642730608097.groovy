...
WebUI.callTestCase(findTestCase('helper/foi-test-login'), [('password') : findTestData('New Test Data').getValue('Password', 12)
        , ('username') : findTestData('New Test Data').getValue('Username', 12)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Innovation, Technology  Investment Capital'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Investment  Innovation'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Management Services'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Mass Timber Implementation'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Ministers Office'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Small Business  Economic Development'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Trade  Industry Development'), 0)
