...
WebUI.callTestCase(findTestCase('helper/foi-test-login'), [('password') : findTestData('Login Credentials').getValue('Password', 
            12), ('username') : findTestData('Login Credentials').getValue('Username', 12)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/ministry view/form/divisional tracking/division dropdown options/jeri/li_Innovation, Technology  Investment Capital'), 
    0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/ministry view/form/divisional tracking/division dropdown options/jeri/li_Investment  Innovation'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/ministry view/form/divisional tracking/division dropdown options/jeri/li_Mass Timber Implementation'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/ministry view/form/divisional tracking/division dropdown options/jeri/li_Small Business  Economic Development'), 
    0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/ministry view/form/divisional tracking/division dropdown options/jeri/li_Trade  Industry Development'), 
    0)
...
WebUI.verifyElementNotPresent(findTestObject('Page_foi.flow/ministry view/form/divisional tracking/a_Add division to track'), 
    0)
