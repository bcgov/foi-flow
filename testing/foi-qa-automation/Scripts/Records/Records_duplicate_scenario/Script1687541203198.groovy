...
WebUI.uploadFile(findTestObject('Page_foi.flow/attachment/input_Add Files_file-upload-input'), RunConfiguration.getProjectDir() + 
    '/Test Attachments/THIS IS CATS  TREES MASTER MSG FILES!.msg')
...
WebUI.click(findTestObject('Records/Duplicate_scenario_elements/span_DEPUTY MINISTERS OFFICE'))
...
WebUI.verifyElementAttributeValue(findTestObject('Records/Duplicate_scenario_elements/svg_INCOMPATIBLE_svg-inline--fa fa-clone fa-w-16 fa-2x jss61'), 
    'data-icon', 'clone', 0)

WebUI.verifyElementAttributeValue(findTestObject('Records/Duplicate_scenario_elements/svg_foiedu, foiedu_svg-inline--fa fa-circle-check fa-w-16 fa-2x jss61 (1)'), 
    'data-icon', 'circle-check', 0)
