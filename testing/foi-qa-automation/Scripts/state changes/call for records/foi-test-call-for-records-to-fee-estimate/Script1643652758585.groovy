...
WebUI.verifyElementText(findTestObject('Page_foi.flow/form/state change dialog/span_State Change Dialog message'), 'Upload Fee Estimate in order to change the state.')
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/form/state change dialog/td_Minstry Next Assignee'), 0)
