...
WebUI.click(findTestObject('Page_foi.flow/li_Fee Estimate'))

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/div_State Change Dialog'), 0)

WebUI.verifyElementText(findTestObject('Page_foi.flow/span_State Change Dialog message'), 'Upload Fee Estimate in order to change the state.')
...
WebUI.uploadFile(findTestObject('Page_foi.flow/attachment/input_Add Files_file-upload-input'), RunConfiguration.getProjectDir() + '/Test Attachments/test.docx' //WebUI.click(findTestObject('Object Repository/Page_foi.flow/button_Sign Out'))
    //WebUI.click(findTestObject('Object Repository/Page_foi.flow/button_Sign Out'))
    )
...
WebUI.verifyElementAttributeValue(findTestObject('Page_foi.flow/form/sidebar/status dropdown/input_Status'), 'value', 'Fee Estimate', 0)
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/comment/p_comment list 2 text'), ((findTestData('New Test Data').getValue(
        'First Name', 8) + ' ') + findTestData('New Test Data').getValue('Last Name', 8)) + ' changed the state of the request to Fee Estimate')

WebUI.click(findTestObject('Page_foi.flow/form/sidebar/a_FOI'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Page_foi.flow/queue/div_request queue row 1 state'), 'Fee Estimate')
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/td_Next Assignee'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/td_Minstry Next Assignee'), 0)
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/queue/div_request queue row 1 state'), 'Call For Records')
