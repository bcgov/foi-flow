...
WebUI.click(findTestObject('Page_foi.flow/li_On Hold'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/queue/div_request queue row 1 state'), 'On Hold')
