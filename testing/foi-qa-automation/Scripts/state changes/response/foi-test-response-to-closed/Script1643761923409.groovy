...
WebUI.verifyElementNotPresent(findTestObject('Page_foi.flow/li_Fee Estimate'), 0)

WebUI.verifyElementNotPresent(findTestObject('Page_foi.flow/li_Deduplication'), 0)

WebUI.verifyElementNotPresent(findTestObject('Page_foi.flow/li_Harms Assessment'), 0)
