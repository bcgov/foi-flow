...
WebUI.verifyElementText(findTestObject('Page_foi.flow/span_State Change Dialog message'), ('Are you sure you want to change ' + 
    WebUI.getText(findTestObject('Page_foi.flow/h1_Ministry Form Request Title'), FailureHandling.STOP_ON_FAILURE)) + ' to Deduplication?')
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/comment/p_comment list 2 text'), ((findTestData('New Test Data').getValue(
        'First Name', 8) + ' ') + findTestData('New Test Data').getValue('Last Name', 8)) + ' changed the state of the request to Deduplication')
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/span_State Change Dialog message'), ('Are you sure you want to change Request #' + 
    WebUI.getText(findTestObject('Page_foi.flow/h3_Form Request Title'), FailureHandling.STOP_ON_FAILURE)) + ' to Harms Assessment?')
