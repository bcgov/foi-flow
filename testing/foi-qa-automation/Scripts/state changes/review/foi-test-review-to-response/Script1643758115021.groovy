...
WebUI.verifyElementText(findTestObject('Page_foi.flow/comment/p_comment list 2 text'), ((findTestData('New Test Data').getValue(
        'First Name', 8) + ' ') + findTestData('New Test Data').getValue('Last Name', 8)) + ' changed the state of the request to Records Review')
...
WebUI.click(findTestObject('Page_foi.flow/li_Response'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/span_State Change Dialog message'), ('Are you sure you want to change Request #' + 
    WebUI.getText(findTestObject('Page_foi.flow/h3_Form Request Title'), FailureHandling.STOP_ON_FAILURE)) + ' to Response?')
...
WebUI.verifyElementAttributeValue(findTestObject('Page_foi.flow/form/sidebar/status dropdown/input_Status'), 'value', 'Response', 0)

WebUI.click(findTestObject('Page_foi.flow/form/sidebar/div_Sidebar Comments'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Page_foi.flow/comment/p_comment list 1 text'), ((findTestData('New Test Data').getValue(
        'First Name', 2) + ' ') + findTestData('New Test Data').getValue('Last Name', 2)) + ' changed the state of the request to Response')
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Records Review'), 0)
...
WebUI.click(findTestObject('Page_foi.flow/li_Records Review'), FailureHandling.STOP_ON_FAILURE)
