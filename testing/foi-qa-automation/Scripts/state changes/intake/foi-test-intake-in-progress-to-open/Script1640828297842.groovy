...
WebUI.verifyElementText(findTestObject('Page_foi.flow/h3_Form Request Title'), 'Review Request')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_foi.flow/li_Open'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_foi.flow/li_Redirect'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_foi.flow/li_Closed'), 0)
...
def requestNo = WebUI.getText(findTestObject('Page_foi.flow/h3_Form Request Title'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/comment/p_comment list 1 text'), ((firstname + ' ') + lastname) + ' changed the state of the request to Open')

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/h4_30 Days Remaining'), 0)
