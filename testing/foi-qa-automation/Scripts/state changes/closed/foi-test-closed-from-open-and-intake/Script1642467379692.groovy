...
WebUI.click(findTestObject('Page_foi.flow/li_Intake In Progress'))
...
WebUI.click(findTestObject('Page_foi.flow/li_Open'))
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/h4_30 Days Remaining'), '')

WebUI.click(findTestObject('Page_foi.flow/form/sidebar/status dropdown/div_Status'))

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Open'), 0)
...
if (today.format('HHmm').toInteger() > 1630) {
    ...
    WebUI.verifyElementText(findTestObject('Page_foi.flow/h4_30 Days Remaining'), '31 Days Remaining')
} else {
    WebUI.verifyElementText(findTestObject('Page_foi.flow/h4_30 Days Remaining'), '30 Days Remaining')
}
