...
WebUI.click(findTestObject('Page_foi.flow/form/sidebar/status dropdown/li_Deduplication'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/comment/p_comment list 1 text'), ((findTestData('New Test Data').getValue(
        'First Name', 7) + ' ') + findTestData('New Test Data').getValue('Last Name', 7)) + ' changed the state of the request to Deduplication')
