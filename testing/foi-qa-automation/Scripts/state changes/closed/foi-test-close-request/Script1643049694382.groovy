...
WebUI.click(findTestObject('Page_foi.flow/li_Closed'))
...
WebUI.verifyElementHasAttribute(findTestObject('Page_foi.flow/form/closing modal/input_Close Request Start Date'), 'disabled', 0)

WebUI.verifyElementAttributeValue(findTestObject('Page_foi.flow/form/closing modal/input_Closing Date'), 'value', today.format('yyyy-MM-dd'), 
    0)

WebUI.verifyElementAttributeValue(findTestObject('Page_foi.flow/form/closing modal/input_Closing Date'), 'max', today.format('yyyy-MM-dd'), 
    0)
...
WebUI.verifyElementNotClickable(findTestObject('Page_foi.flow/button_Save Change'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Page_foi.flow/form/closing modal/div_Closing Reason'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Abandoned'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Access Denied'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Application Fee - Abandoned'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Full Disclosure'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_No Resp. Records ExistLocated'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Outside Scope of Act'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Partial Disclosure'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Records in another MinOrg'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Refuse to Confirm or Deny'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Routinely Releasable'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Section 43'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Transferred'), 0)

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Withdrawn'), 0)

WebUI.click(findTestObject('Page_foi.flow/li_Partial Disclosure'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Page_foi.flow/form/closing modal/div_Closing Reason'), 'Partial Disclosure')

WebUI.verifyElementClickable(findTestObject('Page_foi.flow/button_Save Change'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyMatch(WebUI.getCSSValue(findTestObject('Page_foi.flow/form/sidebar/div_Sidebar'), 'background-color'), 'rgba(0, 0, 0, 1)', 
    false)

WebUI.click(findTestObject('Page_foi.flow/form/sidebar/div_Sidebar Comments'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('Page_foi.flow/comment/p_comment list 1 text'), firstname + ' ' + lastname + ' changed the state of the request to Closed')
