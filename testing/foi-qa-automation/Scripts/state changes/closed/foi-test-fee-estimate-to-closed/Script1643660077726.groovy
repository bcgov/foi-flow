...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_Fee Estimate'), 0)
...
WebUI.verifyElementNotPresent(findTestObject('Page_foi.flow/li_On Hold'), 0)

WebUI.click(findTestObject('Page_foi.flow/li_Fee Estimate'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Page_foi.flow/comment/p_comment list 1 text'), ((findTestData('New Test Data').getValue(
        'First Name', 5) + ' ') + findTestData('New Test Data').getValue('Last Name', 5)) + ' changed the state of the request to Fee Estimate')
