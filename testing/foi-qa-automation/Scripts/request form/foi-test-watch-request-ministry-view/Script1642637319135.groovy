...
WebUI.verifyElementNotPresent(findTestObject('Page_foi.flow/li_Intake Team'), 0)
...
WebUI.verifyElementPresent(findTestObject('Page_foi.flow/li_EDUC Ministry Team'), 0)

WebUI.verifyElementNotHasAttribute(findTestObject('Page_foi.flow/li_assignee user option', [('user') : teammate]), 'aria-selected', 
    0, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Page_foi.flow/li_assignee user option', [('user') : teammate]), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementAttributeValue(findTestObject('Page_foi.flow/li_assignee user option', [('user') : teammate]), 'aria-selected', 
    'true', 0)
...
WebUI.callTestCase(findTestCase('helper/foi-test-login'), [('password') : findTestData('New Test Data').getValue('Password', 9)
        , ('username') : findTestData('New Test Data').getValue('Username', 9)], FailureHandling.STOP_ON_FAILURE)
