...
WebUI.verifyElementHasAttribute(findTestObject('Page_foi.flow/form/inputs/input_noPICheckbox'), 'disabled', 0)
...
WebUI.verifyElementNotClickable(findTestObject('Page_foi.flow/button_Description History'))

WebUI.setText(findTestObject('Page_foi.flow/form/inputs/textarea_request description'), 'test analyst update')

WebUI.scrollToElement(findTestObject('Object Repository/Page_foi.flow/button_Save'), 0)

WebUI.click(findTestObject('Object Repository/Page_foi.flow/button_Save'), FailureHandling.STOP_ON_FAILURE)

WebUI.delay(1, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementClickable(findTestObject('Page_foi.flow/button_Description History'))

WebUI.scrollToElement(findTestObject('Page_foi.flow/form/inputs/input_Country'), 0)

WebUI.click(findTestObject('Page_foi.flow/button_Description History') 
    )

WebUI.verifyElementText(findTestObject('Page_foi.flow/p_request description history entry 1'), description)