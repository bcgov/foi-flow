...
WebUI.scrollToElement(findTestObject('Page_foi.flow/form/inputs/address/Page_U-00129/svg_Category_MuiSvgIcon-root'), 0)

WebUI.waitForElementClickable(findTestObject('Page_foi.flow/form/inputs/address/Page_U-00129/svg_Category_MuiSvgIcon-root'), 
    0)

WebUI.click(findTestObject('Page_foi.flow/form/inputs/address/Page_U-00129/svg_Category_MuiSvgIcon-root'), FailureHandling.STOP_ON_FAILURE)
