...
WebUI.verifyElementText(findTestObject('Page_foi.flow/attachment/span_Are you sure you want to delete the attachment'), 'Are you sure you want to delete the attachment?')
