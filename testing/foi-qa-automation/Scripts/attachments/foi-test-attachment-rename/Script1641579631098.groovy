...
WebUI.verifyElementNotPresent(findTestObject('Page_foi.flow/p_File name cannot contain these characters,'), 0)

WebUI.verifyElementAttributeValue(findTestObject('Page_foi.flow/attachment/input_Rename Attachment'), 'value', 'test', 0)

WebUI.setText(findTestObject('Page_foi.flow/attachment/input_Rename Attachment'), '?')

WebUI.verifyElementPresent(findTestObject('Page_foi.flow/p_File name cannot contain these characters,'), 0)

WebUI.verifyElementText(findTestObject('Page_foi.flow/p_File name cannot contain these characters,'), 'File name cannot contain these characters, / : * ? " < > |')
