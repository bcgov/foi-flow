...
not_run: WebUI.verifyElementNotClickable(findTestObject('CFR/NewCFR/button_Create New CFR Form'))
...
WebUI.scrollToElement(findTestObject('CFR/NewCFR/button_CFR Form History'), 0)

WebUI.click(findTestObject('CFR/NewCFR/button_CFR Form History'))

WebUI.delay(3)

WebUI.click(findTestObject('CFR/CFR_Addcorrespondence/p_CFR Form - Version 1 - Original'))
