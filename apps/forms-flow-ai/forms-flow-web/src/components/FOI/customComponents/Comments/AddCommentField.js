    ...
    <>
      ...
      <div className="inputActions">
        ...
        <div className="col-lg-1 paperplanecontainer">
          ...
          >
            {' '}
            <svg aria-hidden="true" role="img" aria-describedby="addComment" focusable="false" data-prefix="fas" data-icon="paper-plane" class="svg-inline--fa fa-paper-plane fa-w-16 fa-2x " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" disabled={uftext.trim().length === 0} color={ uftext.trim().length === 0 ? '#a5a5a5' : 'darkblue'}>
