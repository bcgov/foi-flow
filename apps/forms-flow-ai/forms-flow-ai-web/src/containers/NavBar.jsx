        ...
        <Navbar collapseOnSelect expand="lg" className="topheading-border-bottom" fixed="top">
          <Container fluid className="service-bc-navbar-background">
            <Navbar.Brand className="d-flex" >
              <div role="img" aria-label="British Columbia Logo">
                <img
                  src={logoPath}
                  width="150px"
                  min-width="87px"
            ...
            {isAuthenticated ?
              <Navbar.Collapse id="responsive-navbar-nav" className="navbar-nav">
                <Nav id="main-menu-nav" className="mr-auto">
                  <Nav.Link eventKey="1" as={Link} to='/form' className={`main-nav nav-item ${pathname.match(/^\/form/) ? "" : "inactive-tab"
                    }`}>
                    <i
                  ...
                  {(getUserRolePermission(userRoles, STAFF_DESIGNER)) ?
                    (<Nav.Link eventKey="10" as={Link} to='/admin' className={`main-nav nav-item ${pathname.match(/^\/admin/) ? "" : "inactive-tab"
                      }`}>
                      <i
                  ...
                  {showApplications ? (getUserRolePermission(userRoles, STAFF_REVIEWER) || getUserRolePermission(userRoles, CLIENT)) ?
                    <Nav.Link eventKey="2" as={Link} to='/application' className={`main-nav nav-item ${pathname.match(/^\/application/) ? "" : "inactive-tab"
                      }`}>
                      <img
